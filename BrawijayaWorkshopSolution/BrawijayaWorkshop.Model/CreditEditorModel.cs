...
namespace BrawijayaWorkshop.Model
{
    public class CreditEditorModel : AppBaseModel
    {
        ...
        public CreditEditorModel(ITransactionRepository transactionRepository, IReferenceRepository referenceRepository,
        ...
        public void InsertCredit(TransactionViewModel transaction)
        {
        ...
        public void UpdateCredit(TransactionViewModel transaction)
        {
