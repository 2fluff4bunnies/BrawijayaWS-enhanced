...
namespace BrawijayaWorkshop.Constant
{
    public static class DbConstant
    {
        ...
        public const string MODUL_BRAND = "M_BRAND";
        public const string MODUL_TYPE = "M_TYPE";
        public const string MODUL_CUSTOMER = "M_CUSTOMER";
        public const string MODUL_JOURNAL = "M_JOURNAL";
        public const string MODUL_VEHICLEGROUP = "MODUL_VEHICLEGROUP";
        ...
        public const string REF_TRANSTBL_INVOICE = "REF_TRANSTBL_INVOICE";
        public const string REF_TRANSTBL_MANUAL = "REF_TRANSTBL_MANUAL";
        public const string REF_TRANSTBL_HPP = "REF_TRANSTBL_HPP";
        public const string REF_TRANSTBL_PURCHASERETURN = "REF_TRANSTBL_PURCHASERETURN";
        public const string REF_TRANSTBL_SALESRETURN = "REF_TRANSTBL_SALESRETURN";
        public const string REF_TRANSTBL_SPAREPARTMANUAL = "REF_TRANSTBL_SPAREPARTMANUAL";
        public const string REF_TRANSTBL_VEHICLE = "REF_TRANSTBL_VEHICLE";
        ...
        public const string REF_PURCHASE_PAYMENTMETHOD_UANGMUKA_BANK_EKONOMI = "REF_PURCHASE_PAYMENTMETHOD_UANGMUKA_BANK_EKONOMI";
        public const string REF_PURCHASE_PAYMENTMETHOD_UANGMUKA_BANK_BCA1 = "REF_PURCHASE_PAYMENTMETHOD_UANGMUKA_BANK_BCA1";
        public const string REF_PURCHASE_PAYMENTMETHOD_UANGMUKA_BANK_BCA2 = "REF_PURCHASE_PAYMENTMETHOD_UANGMUKA_BANK_BCA2";
        ...
        public const string REF_PURCHASE_PAYMENTMETHOD_BANK_EKONOMI = "REF_PURCHASE_PAYMENTMETHOD_BANK_EKONOMI";
        public const string REF_PURCHASE_PAYMENTMETHOD_BANK_BCA1 = "REF_PURCHASE_PAYMENTMETHOD_BANK_BCA1";
        public const string REF_PURCHASE_PAYMENTMETHOD_BANK_BCA2 = "REF_PURCHASE_PAYMENTMETHOD_BANK_BCA2";

        public const string REF_INVOICE_PAYMENTMETHOD = "REF_INVOICE_PAYMENTMETHOD";
        public const string REF_INVOICE_PAYMENTMETHOD_UANGMUKA_KAS = "REF_INVOICE_PAYMENTMETHOD_UANGMUKA_KAS";
        public const string REF_INVOICE_PAYMENTMETHOD_UANGMUKA_BANK_EKONOMI = "REF_INVOICE_PAYMENTMETHOD_UANGMUKA_BANK_EKONOMI";
        public const string REF_INVOICE_PAYMENTMETHOD_UANGMUKA_BANK_BCA1 = "REF_INVOICE_PAYMENTMETHOD_UANGMUKA_BANK_BCA1";
        public const string REF_INVOICE_PAYMENTMETHOD_UANGMUKA_BANK_BCA2 = "REF_INVOICE_PAYMENTMETHOD_UANGMUKA_BANK_BCA2";
        public const string REF_INVOICE_PAYMENTMETHOD_PIUTANG = "REF_INVOICE_PAYMENTMETHOD_PIUTANG";
        public const string REF_INVOICE_PAYMENTMETHOD_KAS = "REF_INVOICE_PAYMENTMETHOD_KAS";
        public const string REF_INVOICE_PAYMENTMETHOD_BANK_EKONOMI = "REF_INVOICE_PAYMENTMETHOD_BANK_EKONOMI";
        public const string REF_INVOICE_PAYMENTMETHOD_BANK_BCA1 = "REF_INVOICE_PAYMENTMETHOD_BANK_BCA1";
        public const string REF_INVOICE_PAYMENTMETHOD_BANK_BCA2 = "REF_INVOICE_PAYMENTMETHOD_BANK_BCA2";

        public const string REF_DEBT_PAYMENTMETHOD = "REF_DEBT_PAYMENTMETHOD";
        public const string REF_DEBT_PAYMENTMETHOD_KAS = "REF_DEBT_PAYMENTMETHOD_KAS";
        public const string REF_DEBT_PAYMENTMETHOD_BANK_EKONOMI = "REF_DEBT_PAYMENTMETHOD_BANK_EKONOMI";
        public const string REF_DEBT_PAYMENTMETHOD_BANK_BCA1 = "REF_DEBT_PAYMENTMETHOD_BANK_BCA1";
        public const string REF_DEBT_PAYMENTMETHOD_BANK_BCA2 = "REF_DEBT_PAYMENTMETHOD_BANK_BCA2";

        public const string REF_USEDGOOD_TRANSACTION_TYPE = "REF_USEDGOOD_TRANSACTION_TYPE";
        public const string REF_USEDGOOD_TRANSACTION_TYPE_SPK = "REF_USEDGOOD_TRANSACTION_TYPE_SPK";
        ...
        public const string REF_HPP_JOURNAL = "REF_HPP_JOURNAL";
        public const string REF_HPP_JOURNAL_SPAREPART = "REF_HPP_JOURNAL_SPAREPART";
